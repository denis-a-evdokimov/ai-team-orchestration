...
tools: ['search', 'read', 'edit', 'web', 'todo', 'agent']
---
...
1. **Plan sprints** — create `docs/sprint-N/plan.md` using the sprint plan template
...
4. **Merge PRs** — review dev team output, merge to main
5. **Coordinate teams** — relay information between dev, QA, and DevOps
6. **Maintain PROJECT_BRIEF.md** — keep it accurate as the single source of truth
7. **Recover context** — when chats overflow, create cold start prompts
